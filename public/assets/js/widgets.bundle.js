                    ...
                    var t,
                        a = function () {
                            ...
                            r
                                .mapPolygons
                                .template
                                .set("fill", am5.color(KTUtil.getCssVariableValue("--bs-primary"))),
                            r
                                .mapPolygons
                                .template
                                .states
            ...
            if (t) {
                var a = t.hasAttribute("data-kt-negative-color")
                    ...
                    i = {
                        ...
                        colors: [
                            KTUtil.getCssVariableValue("--bs-primary"), a
                        ],
                        grid: {
                            borderColor: o,
                            strokeDashArray: 4,
            ...
            if (o) {
                var i = parseInt(KTUtil.css(o, "height")),
                    ...
                    d = {
                        ...
                        colors: [
                            KTUtil.getCssVariableValue("--bs-primary"), KTUtil.getCssVariableValue("--bs-primary-light")
                        ],
                        grid: {
                            borderColor: n,
                            strokeDashArray: 4,
    ...
    var e = function (e, t, a, l) {
        ...
        if (r) {
            ...
            var o = {
                    ...
                    colors: [
                        KTUtil.getCssVariableValue("--bs-info"), KTUtil.getCssVariableValue("--bs-success"), KTUtil.getCssVariableValue("--bs-primary"), KTUtil.getCssVariableValue("--bs-danger")
                    ],
                    stroke: {
                        width: 0
                    },
            ...
            if (t) {
                var a = t.hasAttribute("data-kt-negative-color")
                    ...
                    i = {
                        ...
                        colors: [
                            KTUtil.getCssVariableValue("--bs-gray-800"), a
                        ],
                        grid: {
                            borderColor: o,
                            strokeDashArray: 4,
            ...
            if (t) {
                var a = KTUtil.getCssVariableValue("--bs-gray-800"),
                    ...
                    r = {
                        ...
                        colors: [
                            "#3E97FF", "#F1416C", "#50CD89"
                        ],
                        xaxis: {
                            categories: [
                                "ECR1 - 90%", "FGI - 82%", "EOQ - 75%"
                            ],
                            labels: {
                                formatter: function (e) {
                                    return e + "K"
                ...
                var a = parseInt(KTUtil.css(t, "height")),
                    ...
                    s = {
                        ...
                        markers: {
                            ...
                            strokeColor: [
                                KTUtil.getCssVariableValue("--bs-primary"), KTUtil.getCssVariableValue("--bs-gray-300")
                            ],
                            strokeWidth: 3
                        }
                    };
