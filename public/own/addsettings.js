$(document).ready(function () {
                 ...
                 //console.log(response.data[0].fid);
                   ...
                   location.reload(true);
                    ...
                    $.each(response.message, function (index, value) {
                        ...
                        if(index=="coursename"){
                            $('#e_coursename11').text(value);
                        }

                        if(index=="courseprice"){
                            $('#e_courseprise').text(value);
                        }
    ...
    $('#editcourse').click(function(e){
        ...
        // mandatory
            data: {
                coursename:$('#e_coursename').val(),
                courseprise:$('#e_courseprise').val(),
                courseid:$('#e_courseid').val(),
        ...
        // alert(fid); 
         ...
         // mandatory
             ...
             success: function(response) {
                 ...
                 if (response.status=="success") {
                  //console.log(response.data[0].fid);
                     $('#e_coursename').val(response.data[0].Project_Name);
                     $('#e_courseprise').val(response.data[0].amount);
                     $('#e_courseid').val(response.data[0].pid);
                     $('#project_name').text(response.data[0].Project_Name);
                     $('#project_id_deta').text(response.data[0].pid);
