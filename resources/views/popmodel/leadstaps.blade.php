            ...
            <div class="card-body py-3">
                <div class="table-responsive"
                    ...
                    <table
                        ...
                        <tbody>
                            @foreach ($leadsdatas as $leads)
                            <tr>
                                <td class="align-content-center"> 
                                    <div class="symbol symbol-40px">
                                        <img src="assets/media/Warm.png"
                                            style="    width: 25px;
                                            height: 25px;
                                            z-index: 9;
                                            position: absolute;
                                    ...
                                    <div class="symbol symbol-40px">
                                        <span
                                            ...
                                            <i class="ki-duotone ki-flask fs-2x text-success"
                                                style="font-family: 'arial' !important;">{{$leads->firstletter}}</span></i>
                                        </span>
                                    </div>
                                </td>
                                <td class="align-content-center"> 
                                ...
                                <td class="align-content-center"> 
                                    <div class="d-flex  flex-shrink-0">
                                        <p
                                            class="text-gray-900 fw-norma  fs-6">
                                            <span
                                                class="badge py-3 px-4 fs-8 badge-light-primary">Initiated </span>
                                        </p>
                                    </div>
                                </td>
                                <td class="align-content-center"> 
                                    <div class="d-flex  flex-shrink-0">
                                        <p
                                            class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="Click to Add Deals">
